...
pdf('constrict5_5_1mm.pdf',width=1/mi2in/100,height=1/mi2in/100)
constrictLith(narrowWidth=5,wideWidth=1000,narrowLength=5,wideLength=3000,width=.5,height=1,title='5_5_1mm')
dev.off()
